// React import is used implicitly with JSX
...
export const ImportSuccess: FC<ImportSuccessProps> = ({ 
  importResult, 
  onDashboardClick, 
  onViewHistoryClick 
}) => {
  // Calculate total but don't use it yet
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-xl mx-auto">
            <div className="bg-background border rounded-md p-4 text-center">
              <p className="text-lg font-bold text-green-600">
                {importResult.insertedIds.length}
              </p>
